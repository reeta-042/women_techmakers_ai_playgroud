// ============================================================
//  POSE CLASSIFIER — sketch.js
//  Powered by Teachable Machine + PoseNet + TensorFlow.js
// ============================================================
...
async function startApp() {
  ...
  try {
    ...
    document.getElementById("vidContainer").appendChild(canvas);
...
async function predict() {
  ...
  const prediction = await model.predict(posenetOutput, false, totalClasses);
